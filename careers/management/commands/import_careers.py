# careers/management/commands/import_careers.py
# python manage.py import_careers data/careers.csv --update

import os
from django.core.management.base import BaseCommand, CommandError
from careers.importer.career_importer import CareerImporter


class Command(BaseCommand):
    help = "Production-grade ETL engine to import system Career master reference data files."
