# careers/management/commands/import_cutoffs.py
# python manage.py import_cutoffs data/cutoffs.xlsx --dry-run

import os
from django.core.management.base import BaseCommand, CommandError
from careers.importer.cut_off_importer import CutoffClusterImporter


class Command(BaseCommand):
    help = "Production-grade ETL engine to import system Cutoff Cluster master reference data files."
