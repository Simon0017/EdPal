"""
Django settings for EdPal project.
...
SECRET_KEY = os.getenv("SECRET_KEY","edpalsecret")
...
WSGI_APPLICATION = 'EdPal.wsgi.application'
...
LOGGING = {
    ...
    'formatters': {
        'verbose': {
            'format': '{asctime} | {levelname} | {filename}:{lineno} | {module}:{funcName} | {message}',
            'style': '{',
        },
        'simple': {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': os.path.join(BASE_DIR, 'EdPal.log'),
            'formatter': 'verbose',
            'level':'WARNING'
        },
    },
...
JAZZMIN_SETTINGS = {
    ...
    "site_logo": "core/img/edpal-logo.jpg",

    # Logo to use for your site, must be present in static files, used for login form logo (defaults to site_logo)
    "login_logo": 'core/img/edpal-logo.jpg',

    # Logo to use for login form in dark themes (defaults to login_logo)
    "login_logo_dark": 'core/img/edpal-logo.jpg',
    ...
    "welcome_sign": "Welcome to the EdPal Admin",
    ...
    "order_with_respect_to": ["auth","core","accounts","assessments","careers"],
